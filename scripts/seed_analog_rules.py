...
ANALOG_SELECTION_RULES = [
    ...
    },
    {
        ...
        "excluded_subtypes":   [
            ...
            "irgs_general", "sediment_hosted_general",
            "low_sulfidation_epithermal", "high_sulfidation_epithermal",
            "carlin_general", "vms_general",
        ],
        ...
        "analog_criteria": [
            ...
            "Exclude IRGS/Tintina analogs such as Coffee — they overfit low-grade bulk tonnage outside Abitibi/Yilgarn-style orogenic settings",
    ...
    },
    {
        ...
        "required_patterns":   ["vein_hosted", "breccia_hosted", "stockwork"],
        ...
        "excluded_patterns":   ["disseminated_bulk", "replacement", "reef", "blanket", "placer"],
        "preferred_alteration":["sericitic_quartz"],
        "excluded_recovery":   ["iscr", "hpal"],
        "required_mining_methods": ["underground_vein", "open_pit_selective"],
        "excluded_mining_methods": ["open_pit_bulk", "iscr_in_situ", "dredging"],
        "tonnage_match_max_ratio": 8.0,
        "grade_match_max_ratio":   5.0,
        "min_resource_year":   2010,
        "min_profile_strength": 5,
        "applies_lessons":     ["LG1", "LG19", "LG136", "LG154", "L_EPI_01", "L_EPI_02"],
        "analog_criteria": [
    ...
    },
    {
        ...
        "required_patterns":   ["breccia_hosted", "stockwork", "disseminated_bulk"],
        ...
        "excluded_patterns":   ["vein_hosted", "replacement", "reef", "blanket", "placer"],
        "preferred_alteration":["argillic_advanced_argillic"],
        "required_mining_methods": ["open_pit_bulk", "open_pit_selective", "underground_bulk"],
        "excluded_mining_methods": ["underground_vein", "iscr_in_situ", "dredging"],
        "tonnage_match_max_ratio": 8.0,
        "grade_match_max_ratio":   5.0,
        "min_resource_year":   2010,
        "min_profile_strength": 5,
        "applies_lessons":     ["LG1", "LG19", "LG136", "LG154", "L_EPI_02", "L_EPI_03"],
        "analog_criteria": [
    ...
    },
    {
        ...
        "required_patterns":   ["stockwork", "disseminated_bulk"],
        "required_modes":      ["primary_sulfide"],
        "excluded_subtypes":   [
            "iocg_oxide", "iocg_sulfide", "iocg_hybrid",
            "oxide_iscr_supergene_blanket",
            "greenstone_orogenic", "turbidite_orogenic", "orogenic_general",
            "low_sulfidation_epithermal", "intermediate_sulfidation_epithermal",
            "high_sulfidation_epithermal", "carlin_general",
        ],
        "excluded_recovery":   ["iscr", "hpal"],
        ...
        "analog_criteria": [
            ...
            "Heap-leach pads are valid only for oxidized low-grade Au porphyry targets; do not use Carlin refractory resources as substitutes",
        ],
        "tonnage_multiplier": 1.0, "grade_multiplier": 1.0, "confidence_modifier": 0,
    },
    {
